...
var Template = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
                ...
                Template.blockUI(pageContent, false);

                $.post(url, {}, function (res) {
                        Template.unblockUI(pageContent);
                        pageContentBody.html(res);
                        Template.fixContentHeight(); // fix content height
                        Template.initUniform(); // initialize uniform elements
                    });
            });
    }
    ...
    var handleTooltips = function () {
        if (Template.isTouchDevice()) { // if touch device, some tooltips can be skipped in order to not conflict with click events
    ...
    return {
        ...
        init: function () {
            ...
            Template.addResponsiveHandler(handleChoosenSelect); // reinitiate chosen dropdown on main content resize. disable this line if you don't really use chosen dropdowns.
        },
